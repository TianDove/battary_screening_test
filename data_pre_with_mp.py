...
class FileOrganizer():
    ...
    def file_organize(self, is_write: bool = True):
        """"""
        ...
        text_data = '| Finish Date: {} | Write Flag: {} | Multiprocess Flag: {} | Time Consume: {} s |'.format(
            now_time, is_write, self.is_multi_worker, consumed_time)
    ...
    def batch_worker(self, batch: str) -> (list, list):
        ...
        text = "#{}-Processing...".format(curr_batch)
            ...
            for tray in iter(tray_list):
                ...
                for cell in iter(cell_no):
                    ...
                    if self.is_write:
                        ...
                        write_pickle_path = os.path.join(self.out_path + '\\organized_data\\pickle', curr_cell + '.pickle')
...
if __name__ == '__main__':
    ...
    m_file_organizer.file_organize(is_write=True)
